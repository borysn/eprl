...
def noOptionsSpecified(args): 
    # init return
    result = False
    if not (args.list == False and args.clear == False and args.itemNums == None and args.items == None and args.clear == None and args.export == False and args.importing == False):
        result = True
    return result
